...
<html lang="en">
    <head>
        ...
        <title>Accommodation | Waqtcal</title>
    ...
    <body>
        ...
        <p class="breadcrumb-sp zoomInDown wow" data-wow-duration="0.5s" data-wow-delay=".5s">HOME/<span class="breadcrumb-sp-span"> ACCOMMODATION</span></p>
        
        <div class="page_t zoomIn wow" data-wow-duration="0.5s" data-wow-delay=".5s" align="center">
            <h1 class="divide">Accommodation</h1>
        </div>
        
        <div class="container zoomIn wow" data-wow-duration="0.5s" data-wow-delay=".5s" id="page_container">
            <div class="row">
                <div class="col-xl-12" align="center">
                    <p class="tc-p">Technical requirements of accommodation and environmental conditions affecting testing/ calibration 
                        are well documented and controlled. WAQTCAL LAB monitors, control and record environmental conditions. WAQTCAL 
                        LAB has effective separation between neighboring areas. Also, uses controlled access to testing/ calibration 
                        areas. WAQTCAL uses Good housekeeping standards.</p>
                </div>
            </div>
        </div>
