...
<html lang="en">
    ...
    <body>
        ...
        <p class="breadcrumb-sp zoomInDown wow" data-wow-duration="0.5s" data-wow-delay=".5s">HOME/<span class="breadcrumb-sp-span"> PERSONNEL</span></p>
        
        <div class="page_t zoomIn wow" data-wow-duration="0.5s" data-wow-delay=".5s" align="center">
            <h1 class="divide">Personnel</h1>
        </div>
        
        <div class="container zoomIn wow" data-wow-duration="0.5s" data-wow-delay=".5s" id="page_container">
            <div class="row">
                <div class="col-xl-12" align="center">
                    <p class="tc-p">WAQTCAL Personnel performing specific tasks are qualified on the basis of education, training, 
                        experience and skills.<br><br>WAQTCAL has Policy and procedure for identifying training needs and providing 
                        training are clearly planned and ensure the same is in place.<br><br>Normally, most of our works are done by 
                        WAQTCAL personnel only and if in case we require any contracted personnel, WAQTCAL ensure that contracted 
                        personnel work in accordance with laboratory's Management Systems.<br><br>WAQTCAL maintain a proper job 
                        description of technical, managerial and key personnel working in the company. Also, WAQTCAL maintain the 
                        records of qualifications, training and skills of personnel. WAQTCAL gives authority to only authorized 
                        personnel for testing/calibration issue of certificates, interpretations, opinions, operation of particular 
                        equipment.</p>
                </div>
            </div>
        </div>
